...
void AtualizarPowerUps(EstadoJogojogo, float delta);
...
void DesenharPowerUpColetavel(const EstadoJogojogo);
...
void DesenharEscudoJogador(const EstadoJogojogo);
...
void DesenharIndicadoresPowerUps(const EstadoJogojogo);
